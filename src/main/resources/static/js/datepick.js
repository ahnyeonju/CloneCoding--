...
$(function(){
   ...
   $('.ahn_btn_date .date_view b').html(mm+'.'+''+dd+' - '+mm+'.'+''+dd); // 오늘 날짜 셋팅
   
   $('.ahn_btn_date').click(function(e){ // 트리거 클릭 
      e.preventDefault();
      dateopen_trigger();
   });

   $('.detail .ahn_btn_date').click(function(){
   ...
   $(".ahn_product_date").daterangepicker({ // Date Range Picker 
      dateFormat : 'mm.dd',
...
// 안먹는듯
   ...
   $(".ahn_product_date").on('daterangepickerclose', function(event, data) {  // 선택완료
