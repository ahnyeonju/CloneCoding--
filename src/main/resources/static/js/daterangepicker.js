...
(function(root, factory) {
    ...
    // Finally, as a browser global.
      ...
      DateRangePicker.prototype = {
          ...
          setOptions: function(options, callback) {
              ...
              //moment.locale('ko'); 언어를 한국어로 설정함! 이거때문에 오류날까?
  ...
  // 바깥을 눌렀을때
          ...
          //안연주 적용버튼 클릭시 input박스에 출력되는 글씨
      
          updateInputText: function() {
  
              // var ahn_sel_date = $('#ahn_sel_date').value('ahn_sel_date').split('-');
              // var ahn_sel_date2 = $('#ahn_sel_date2').value('ahn_sel_date2').split('-');
              // var diff_day = (
              //     Math.floor(new Date(ahn_sel_date2[0], (ahn_sel_date2[1] - 1), ahn_sel_date2[2], 0, 0, 0).getTime() / 1000) -
              //     Math.floor(new Date(ahn_sel_date[0], (ahn_sel_date[1] - 1), ahn_sel_date[2], 0, 0, 0).getTime() / 1000)
              // ) / 86400;
